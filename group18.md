...
## 2024303110082 余晓雯
学号：2024303110082
个人收获：通过本课程的学习，我学会了一些关于使用R和Python进行数据分析的内容，课程中的项目实践让我有机会将理论知识应用到实际问题中，提高了我的动手能力和解决实际问题的能力；在遇到代码报错等问题时，我也可以自主去搜索相关解决方法并尝试重新运行；这对我的动手能力有很大提升；通过VSCode查阅文献的内容也让我有很大收获。
建议与意见：我认为课程内容非常丰富，但建议可以变成更少人数的课堂，比如分班后每个班几十个人，在机房进行，老师操作电脑时可以同步所有电脑屏幕的画面，这样可以使大家更加清楚地看到板书和具体如何操作；且本课程中并没有很清晰的感受到助教的引导作用，基本上是在和同学一起摸索，希望以后开展课程可以优化一下这些方面。
课程总结：总体而言，这门课让我对一些数据分析相关的软件有更深刻的理解，并尝试进行使用与分析，在今后的科研生活中如果有需要用到的地方，这门课程的学习会是一个很好的切入点。
